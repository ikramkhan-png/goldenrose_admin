            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.clients.index') }}" method="GET" class="d-flex align-items-end gap-4 flex-wrap">
                    ...
                    <div style="min-width: 120px;">
                        ...
                        <a href="{{ route('admin.clients.index') }}" class="btn btn-outline-secondary w-100" style="padding: 12px 14px; border: 2px solid #6c757d; border-radius: 8px; font-weight: 500; font-size: 14px;">
