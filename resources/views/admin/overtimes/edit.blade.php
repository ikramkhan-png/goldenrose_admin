...
<div dir="{{ $isAr ? 'rtl' : 'ltr' }}">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        <div>
            <h4 class="page-title">{{ __('admin.edit_overtime_title') }}</h4>
            ...
            <div class="form-card">
                <form action="{{ route('admin.overtimes.update', $overtime->id) }}" method="POST">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>{{ __('admin.update_overtime') }}</button>
